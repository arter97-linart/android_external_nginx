#define NGX_CONFIGURE " --without-pcre --without-http_rewrite_module --with-http_mp4_module --with-http_flv_module --with-http_spdy_module --prefix=/system/etc/nginx"

#ifndef NGX_COMPILER
#define NGX_COMPILER  "AOSP toolchain (Android / Bionic) ported by arter97"
#endif
...
#ifndef NGX_HAVE_F_READAHEAD
#define NGX_HAVE_F_READAHEAD 0
#endif
...
#ifndef NGX_PREFIX
#define NGX_PREFIX  "/system/etc/nginx/"
#endif
